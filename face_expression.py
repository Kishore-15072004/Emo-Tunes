...
def analyze_expression(landmarks, width, height):
    ...
    left_eyebrow_inner = landmarks[70]  # Inner part of left eyebrow
    right_eyebrow_inner = landmarks[300]  # Inner part of right eyebrow
    ...
    left_eyebrow = denormalize(left_eyebrow_inner)
    right_eyebrow = denormalize(right_eyebrow_inner)
    ...
    if mouth_height / mouth_width > 0.5 and eyebrow_distance < eye_distance:
        return "Surprised"
    elif mouth_width / eye_distance > 1.8:
        return "Smiling"
    elif mouth_height / mouth_width < 0.15 and mouth_width / eye_distance < 1.5:
        return "Neutral"
    elif eyebrow_distance < eye_distance and mouth_height / mouth_width < 0.15:
        return "Sad"
    elif eyebrow_distance < eye_distance and mouth_height / mouth_width > 0.3:
        return "Fear"
    elif eyebrow_distance > eye_distance and mouth_height / mouth_width > 0.5:
        return "Disgusted"
    else:
        return "Angry"
